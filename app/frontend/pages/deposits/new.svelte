...
<div class="bg-white rounded-2 container">
  ...
  <div class="p-4">
    <p class="mb-8">
      Deposited funds will show up as "available cash" in your portfolio.
    ...
    <div class="mt-4">
      <div class="important mb-4">
        Please make sure to use the correct reference code, otherwise your deposit cannot be assigned to your account and will be returned to you.
      </div>
      <div class="md:flex ">
        <table class="flex-1">
          <tbody>
    ...
    <div class="notice">
      ...
      <p>
        <strong>Fees:</strong> We don't charge deposit fees for SEPA transactions. However, your bank might charge fees for the transaction.
      </p>
    </div>
    </div>
  </div>
